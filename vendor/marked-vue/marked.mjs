...
class _Renderer {
    ...
    code({ text, lang, escaped }) {
        ...
        if (!langString) {
            return h('pre', {}, h('code', { innerHTML: escaped ? code : escape(code) }));
        }
        return h('pre', { class: 'code--' + escape(langString) }, h('code', {
            class: 'code--' + escape(langString),
    ...
    table(token) {
        ...
        const body = token.rows.map(row => this.tablerow(row.map(cell => this.tablecell(cell))));
